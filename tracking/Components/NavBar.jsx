    ...
    <>
      <nav
        className={`bg-white pb-5 md:text-sm ${
          state
            ? "shadow-lg rounded-xl border mx-2 mt-2 md:shadow-none md:border-none md:mx-2 md:mt-04"
            : ""
        }`}
      >
        <div className="gap-x-14 items-center max-w-screen-xl mx-auto px-4 md:flex md:px-8">
          ...
          >
            ...
            <div className="flex-1 gap-z-6 items-center justify-end mt-6 space-y-6 md:flex md:space-y-0 md:mt-0">
              {currentUser ? (
