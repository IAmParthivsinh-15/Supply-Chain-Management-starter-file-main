          ...
          <div className="max-w-sm mx-auto py-3 space-y-3 text-center">
            ...
            <form onSubmit={(e) => e.preventDefault()}>
              ...
              <button
                ...
                className="block w-full mt-3 py- px-4 font-medium text-sm text-center text-white bg-indigo-600 hover:bg-indigo-400 active:bg-indigo-800 rounded-lg ring-offset-2 ring-indigo-600 focus:ring-2"
              >
                Get Details
              </button>
            </form>
            {singleShipmentData === undefined ? (
              ...
              <div className="text-left">
                ...
                <p>
                  Delivery Time : {converTime(singleShipmentData.deliveryTime)}{" "}
                </p>
